...
public class PongGame extends SurfaceView  implements Runnable{
    ...
    private void update()
    {
        ...
        // Update the bat and ball position.
        mBall.update(mFPS);
        mBat.update(mFPS);
    }
    ...
    private void draw() {
        ...
        private void printDebuggingText(){
            ...
            //debugging will always be half the fontsize on the HUD
            int debugSize = mFontSize / 2;
            //debug start is an arbitrary value for a vertical margin from the top of the screen to start printing the debugging text
            int debugStart = 150;

            //
            mPaint.setTextSize(debugSize);
            // message, x postion, y position, paint bject that holds arg values
